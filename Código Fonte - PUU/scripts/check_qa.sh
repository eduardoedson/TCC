...
./manage.py check
flake8 --exclude='ipython_log.py*, migrations, templates, settings.py' .
isort --recursive --check-only --skip='migrations' --skip='templates' --skip='ipython_log.py' --skip='settings.py' .
