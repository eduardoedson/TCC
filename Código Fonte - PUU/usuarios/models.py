...
class FisioterapiaAvaliacaoGestacional(models.Model):
    ...
    gestacional_tipo_sangue = models.CharField(max_length=2, verbose_name=_('Tipagem Sanguínea'), choices=[('A', 'A'), ('B', 'B'), ('AB', 'AB'), ('O', 'O')])
    gestacional_fator_rh = models.CharField(max_length=1, verbose_name=_('Fator RH'), choices=[('-', '-'), ('+', '+')])
    ...
    antecedentes_ciclo = models.CharField(max_length=40, verbose_name=_('Regularidade do Ciclo Menstrual'), choices=YES_NO_CHOICES)
    antecedentes_cirurgia = models.CharField(max_length=40, verbose_name=_('Cirurgia ou Doença Ginecológica Anterior'), choices=YES_NO_CHOICES)
    ...
    obstetrica_parto = models.CharField(max_length=40, verbose_name=_('Tipo de Parto'), choices=[('Normal', 'Normal'), ('Cesárea', 'Cesárea'), ('Fórceps', 'Usou Fórceps')])
    ...
    infecciosas_tuberculose = models.CharField(max_length=40, verbose_name=_('Tuberculose'), choices=YES_NO_CHOICES)
    infecciosas_sifilis = models.CharField(max_length=40, verbose_name=_('Sífilis'), choices=YES_NO_CHOICES)
    infecciosas_rubeola = models.CharField(max_length=40, verbose_name=_('Rubéola'), choices=YES_NO_CHOICES)
    infecciosas_tuxoplasmose = models.CharField(max_length=40, verbose_name=_('Tuxoplasmose'), choices=YES_NO_CHOICES)
    infecciosas_sarampo = models.CharField(max_length=40, verbose_name=_('Sarampo'), choices=YES_NO_CHOICES)
    infecciosas_hepatite = models.CharField(max_length=40, verbose_name=_('Hepatite'), choices=YES_NO_CHOICES)

    habitos_tabagismo = models.CharField(max_length=40, verbose_name=_('Tabagismo'), choices=YES_NO_CHOICES)
    habitos_etilismo = models.CharField(max_length=40, verbose_name=_('Etilismo'), choices=YES_NO_CHOICES)
    habitos_drogas = models.CharField(max_length=40, verbose_name=_('Drogas'), choices=YES_NO_CHOICES)
    habitos_alimentacao = models.CharField(max_length=40, verbose_name=_('Alimentação'), choices=YES_NO_CHOICES)
    habitos_medicamentos = models.CharField(max_length=40, verbose_name=_('Medicamentos'), choices=YES_NO_CHOICES)
    ...
    historia_perda = models.CharField(max_length=40, verbose_name=_('Tem perda de urina?'), choices=YES_NO_CHOICES)
    ...
    historia_dor = models.CharField(max_length=40, verbose_name=_('Existe Dor ao Urinar?'), choices=YES_NO_CHOICES)
...
class FisioterapiaOrtopediaAvaliacao(models.Model):
    ...
    # Mapa Muscular
    reto_abdominal_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Reto Abdominal] [T7, I2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    reto_abdominal_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Reto Abdominal] [T7, I2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    reto_abdominal_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Reto Abdominal] [T7, I2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    reto_abdominal_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Reto Abdominal] [T7, I2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    reto_abdominal_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Reto Abdominal] [T7, I2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    reto_abdominal_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Reto Abdominal] [T7, I2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    obliquo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação] [Oblíquio Externo/Interno] [T8,T12 (L1)] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    obliquo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação] [Oblíquio Externo/Interno] [T8,T12 (L1)] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    obliquo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação] [Oblíquio Externo/Interno] [T8,T12 (L1)] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    obliquo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação] [Oblíquio Externo/Interno] [T8,T12 (L1)] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    obliquo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação] [Oblíquio Externo/Interno] [T8,T12 (L1)] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    obliquo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação] [Oblíquio Externo/Interno] [T8,T12 (L1)] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    toracico_lombar_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Grupo Torácido/Lombar] [Pós. Rima] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    toracico_lombar_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Grupo Torácido/Lombar] [Pós. Rima] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    toracico_lombar_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Grupo Torácido/Lombar] [Pós. Rima] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    toracico_lombar_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Grupo Torácido/Lombar] [Pós. Rima] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    toracico_lombar_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Grupo Torácido/Lombar] [Pós. Rima] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    toracico_lombar_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Grupo Torácido/Lombar] [Pós. Rima] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    quadrado_lombar_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Elevação Pélvis] [Quadrado Lombar] [T12, L1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    quadrado_lombar_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Elevação Pélvis] [Quadrado Lombar] [T12, L1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    quadrado_lombar_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Elevação Pélvis] [Quadrado Lombar] [T12, L1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    quadrado_lombar_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Elevação Pélvis] [Quadrado Lombar] [T12, L1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    quadrado_lombar_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Elevação Pélvis] [Quadrado Lombar] [T12, L1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    quadrado_lombar_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Elevação Pélvis] [Quadrado Lombar] [T12, L1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    iliopsoas_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Iliopsoas] [L2, L3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    iliopsoas_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Iliopsoas] [L2, L3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    iliopsoas_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Iliopsoas] [L2, L3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    iliopsoas_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Iliopsoas] [L2, L3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    iliopsoas_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Iliopsoas] [L2, L3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    iliopsoas_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Iliopsoas] [L2, L3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    sartorio_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Sartório] [L2, L3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    sartorio_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Sartório] [L2, L3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    sartorio_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Sartório] [L2, L3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    sartorio_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Sartório] [L2, L3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    sartorio_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Sartório] [L2, L3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    sartorio_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Sartório] [L2, L3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    gluteo_maximo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Glúteo Máximo] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_maximo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Glúteo Máximo] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_maximo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Glúteo Máximo] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_maximo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Glúteo Máximo] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_maximo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Glúteo Máximo] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_maximo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Glúteo Máximo] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    tensor_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão ABD+RI] [Tensor da Fáscia Lata] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tensor_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão ABD+RI] [Tensor da Fáscia Lata] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tensor_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão ABD+RI] [Tensor da Fáscia Lata] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tensor_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão ABD+RI] [Tensor da Fáscia Lata] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    tensor_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão ABD+RI] [Tensor da Fáscia Lata] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    tensor_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão ABD+RI] [Tensor da Fáscia Lata] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    gluteo_medio_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução] [Gúteo Médio] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_medio_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução] [Gúteo Médio] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_medio_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução] [Gúteo Médio] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_medio_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução] [Gúteo Médio] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_medio_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução] [Gúteo Médio] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_medio_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução] [Gúteo Médio] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    adutores_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução] [Adutores] [L3, L4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    adutores_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução] [Adutores] [L3, L4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    adutores_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução] [Adutores] [L3, L4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    adutores_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução] [Adutores] [L3, L4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    adutores_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução] [Adutores] [L3, L4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    adutores_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução] [Adutores] [L3, L4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    rotacao_externa_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Externa] [Rotação Externos] [L3, L4, L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    rotacao_externa_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Externa] [Rotação Externos] [L3, L4, L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    rotacao_externa_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Externa] [Rotação Externos] [L3, L4, L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    rotacao_externa_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Externa] [Rotação Externos] [L3, L4, L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    rotacao_externa_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Externa] [Rotação Externos] [L3, L4, L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    rotacao_externa_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Externa] [Rotação Externos] [L3, L4, L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    gluteo_minimo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Interna] [Glúteo Mínimo] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_minimo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Interna] [Glúteo Mínimo] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_minimo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Interna] [Glúteo Mínimo] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_minimo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Interna] [Glúteo Mínimo] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_minimo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Interna] [Glúteo Mínimo] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gluteo_minimo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Interna] [Glúteo Mínimo] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    biceps_femural_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Bíceps Femural] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    biceps_femural_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Bíceps Femural] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    biceps_femural_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Bíceps Femural] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    biceps_femural_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Bíceps Femural] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    biceps_femural_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Bíceps Femural] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    biceps_femural_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Bíceps Femural] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    semitendinoso_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Semitendinoso/Semimembranoso] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    semitendinoso_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Semitendinoso/Semimembranoso] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    semitendinoso_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Semitendinoso/Semimembranoso] [L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    semitendinoso_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Semitendinoso/Semimembranoso] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    semitendinoso_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Semitendinoso/Semimembranoso] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    semitendinoso_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Semitendinoso/Semimembranoso] [L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    quadriceps_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Quadriceps] [L2, L3, L4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    quadriceps_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Quadriceps] [L2, L3, L4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    quadriceps_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Quadriceps] [L2, L3, L4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    quadriceps_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Quadriceps] [L2, L3, L4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    quadriceps_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Quadriceps] [L2, L3, L4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    quadriceps_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Quadriceps] [L2, L3, L4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    gastrocnemio_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão Plantar] [Gastrocnêmio] [S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gastrocnemio_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão Plantar] [Gastrocnêmio] [S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gastrocnemio_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão Plantar] [Gastrocnêmio] [S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    gastrocnemio_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão Plantar] [Gastrocnêmio] [S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gastrocnemio_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão Plantar] [Gastrocnêmio] [S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    gastrocnemio_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão Plantar] [Gastrocnêmio] [S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    soleo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão Plantar] [Sóleo] [S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    soleo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão Plantar] [Sóleo] [S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    soleo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão Plantar] [Sóleo] [S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    soleo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão Plantar] [Sóleo] [S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    soleo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão Plantar] [Sóleo] [S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    soleo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão Plantar] [Sóleo] [S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    tibial_anterior_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Inversão] [Tibial Inferior] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_anterior_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Inversão] [Tibial Inferior] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_anterior_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Inversão] [Tibial Inferior] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_anterior_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Inversão] [Tibial Inferior] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_anterior_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Inversão] [Tibial Inferior] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_anterior_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Inversão] [Tibial Inferior] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    tibial_posterior_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Inversão] [Tibial Posterior] [L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_posterior_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Inversão] [Tibial Posterior] [L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_posterior_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Inversão] [Tibial Posterior] [L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_posterior_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Inversão] [Tibial Posterior] [L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_posterior_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Inversão] [Tibial Posterior] [L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    tibial_posterior_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Inversão] [Tibial Posterior] [L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    fibular_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Eversão] [Fibular Longo/Curto] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    fibular_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Eversão] [Fibular Longo/Curto] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    fibular_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Eversão] [Fibular Longo/Curto] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    fibular_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Eversão] [Fibular Longo/Curto] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    fibular_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Eversão] [Fibular Longo/Curto] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    fibular_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Eversão] [Fibular Longo/Curto] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    extensor_dedos_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Extensor Curto/Longo Dedos] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_dedos_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Extensor Curto/Longo Dedos] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_dedos_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Extensor Curto/Longo Dedos] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_dedos_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Extensor Curto/Longo Dedos] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_dedos_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Extensor Curto/Longo Dedos] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_dedos_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Extensor Curto/Longo Dedos] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    halux_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Extensor Longo Halux] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    halux_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Extensor Longo Halux] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    halux_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Extensor Longo Halux] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    halux_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Extensor Longo Halux] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    halux_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Extensor Longo Halux] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    halux_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Extensor Longo Halux] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_dedos_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Flexor Curto/Longo Dedos] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_dedos_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Flexor Curto/Longo Dedos] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_dedos_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Flexor Curto/Longo Dedos] [L4, L5, S1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_dedos_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Flexor Curto/Longo Dedos] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_dedos_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Flexor Curto/Longo Dedos] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_dedos_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Flexor Curto/Longo Dedos] [L4, L5, S1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_halux_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Flexor Curto/Longo Halux] [L4, L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_halux_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Flexor Curto/Longo Halux] [L4, L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_halux_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Flexor Curto/Longo Halux] [L4, L5, S1, S2] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_halux_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Flexor Curto/Longo Halux] [L4, L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_halux_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Flexor Curto/Longo Halux] [L4, L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_halux_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Flexor Curto/Longo Halux] [L4, L5, S1, S2] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    esternocleidomastoideo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Esternocleidomastóideo] [CN, XI, C2, C3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    esternocleidomastoideo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Esternocleidomastóideo] [CN, XI, C2, C3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    esternocleidomastoideo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Esternocleidomastóideo] [CN, XI, C2, C3] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    esternocleidomastoideo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Esternocleidomastóideo] [CN, XI, C2, C3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    esternocleidomastoideo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Esternocleidomastóideo] [CN, XI, C2, C3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    esternocleidomastoideo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Esternocleidomastóideo] [CN, XI, C2, C3] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    trapezio_extensores_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Trapézio (Superior) Extensores] [CN, XI, C2, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_extensores_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Trapézio (Superior) Extensores] [CN, XI, C2, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_extensores_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Trapézio (Superior) Extensores] [CN, XI, C2, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_extensores_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Trapézio (Superior) Extensores] [CN, XI, C2, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_extensores_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Trapézio (Superior) Extensores] [CN, XI, C2, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_extensores_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Trapézio (Superior) Extensores] [CN, XI, C2, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    serratil_anterior_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução] [Serrátil Anterior] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    serratil_anterior_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução] [Serrátil Anterior] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    serratil_anterior_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução] [Serrátil Anterior] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    serratil_anterior_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução] [Serrátil Anterior] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    serratil_anterior_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução] [Serrátil Anterior] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    serratil_anterior_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução] [Serrátil Anterior] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    trapezio_elevador_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Elevação] [Trapézio (Superior) Elevador Escápula] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_elevador_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Elevação] [Trapézio (Superior) Elevador Escápula] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_elevador_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Elevação] [Trapézio (Superior) Elevador Escápula] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_elevador_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Elevação] [Trapézio (Superior) Elevador Escápula] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_elevador_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Elevação] [Trapézio (Superior) Elevador Escápula] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_elevador_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Elevação] [Trapézio (Superior) Elevador Escápula] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    trapezio_inferior_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Depressão e Adução Escapular] [Trapézio Inferior] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_inferior_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Depressão e Adução Escapular] [Trapézio Inferior] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_inferior_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Depressão e Adução Escapular] [Trapézio Inferior] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_inferior_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Depressão e Adução Escapular] [Trapézio Inferior] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_inferior_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Depressão e Adução Escapular] [Trapézio Inferior] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_inferior_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Depressão e Adução Escapular] [Trapézio Inferior] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    trapezio_medidas_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução] [Trapézio F. Medidas] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_medidas_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução] [Trapézio F. Medidas] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_medidas_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução] [Trapézio F. Medidas] [CN, XI, C3, C4] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_medidas_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução] [Trapézio F. Medidas] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_medidas_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução] [Trapézio F. Medidas] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    trapezio_medidas_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução] [Trapézio F. Medidas] [CN, XI, C3, C4] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    romboides_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução] [Rombóides] [C5] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    romboides_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução] [Rombóides] [C5] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    romboides_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução] [Rombóides] [C5] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    romboides_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução] [Rombóides] [C5] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    romboides_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução] [Rombóides] [C5] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    romboides_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução] [Rombóides] [C5] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    deltoide_caracobraquial_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Deltóide Anterior Caracobraquial] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_caracobraquial_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Deltóide Anterior Caracobraquial] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_caracobraquial_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Deltóide Anterior Caracobraquial] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_caracobraquial_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Deltóide Anterior Caracobraquial] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_caracobraquial_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Deltóide Anterior Caracobraquial] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_caracobraquial_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Deltóide Anterior Caracobraquial] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    grande_dorsal_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Grande Dorsal] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    grande_dorsal_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Grande Dorsal] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    grande_dorsal_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Grande Dorsal] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    grande_dorsal_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Grande Dorsal] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    grande_dorsal_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Grande Dorsal] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    grande_dorsal_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Grande Dorsal] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    Subscapular_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Interna] [Subscapular Redondo Maior] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    Subscapular_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Interna] [Subscapular Redondo Maior] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    Subscapular_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Interna] [Subscapular Redondo Maior] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    Subscapular_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Interna] [Subscapular Redondo Maior] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    Subscapular_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Interna] [Subscapular Redondo Maior] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    Subscapular_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Interna] [Subscapular Redondo Maior] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    deltoide_medio_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução] [Deltóide Médio Supra-Espinhoso] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_medio_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução] [Deltóide Médio Supra-Espinhoso] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_medio_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução] [Deltóide Médio Supra-Espinhoso] [C5, C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_medio_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução] [Deltóide Médio Supra-Espinhoso] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_medio_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução] [Deltóide Médio Supra-Espinhoso] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    deltoide_medio_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução] [Deltóide Médio Supra-Espinhoso] [C5, C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    peitoral_maior_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução Horizontal] [Peitoral Maior] [C5, C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    peitoral_maior_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução Horizontal] [Peitoral Maior] [C5, C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    peitoral_maior_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução Horizontal] [Peitoral Maior] [C5, C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    peitoral_maior_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução Horizontal] [Peitoral Maior] [C5, C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    peitoral_maior_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução Horizontal] [Peitoral Maior] [C5, C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    peitoral_maior_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução Horizontal] [Peitoral Maior] [C5, C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    infraespinhoso_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Externa] [Infra-Espinhoso Redondo Menor] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    infraespinhoso_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Externa] [Infra-Espinhoso Redondo Menor] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    infraespinhoso_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Externa] [Infra-Espinhoso Redondo Menor] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    infraespinhoso_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Rotação Externa] [Infra-Espinhoso Redondo Menor] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    infraespinhoso_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Rotação Externa] [Infra-Espinhoso Redondo Menor] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    infraespinhoso_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Rotação Externa] [Infra-Espinhoso Redondo Menor] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    briceps_braquial_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Bíceps/Braquial] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    briceps_braquial_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Bíceps/Braquial] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    briceps_braquial_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Bíceps/Braquial] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    briceps_braquial_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Bíceps/Braquial] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    briceps_braquial_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Bíceps/Braquial] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    briceps_braquial_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Bíceps/Braquial] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    braquioradial_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Braquioradial] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    braquioradial_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Braquioradial] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    braquioradial_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Braquioradial] [C5, C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    braquioradial_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Braquioradial] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    braquioradial_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Braquioradial] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    braquioradial_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Braquioradial] [C5, C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    triceps_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Tríceps] [C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    triceps_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Tríceps] [C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    triceps_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Tríceps] [C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    triceps_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Tríceps] [C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    triceps_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Tríceps] [C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    triceps_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Tríceps] [C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    supinador_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Supinação] [Supinador] [C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    supinador_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Supinação] [Supinador] [C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    supinador_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Supinação] [Supinador] [C6] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    supinador_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Supinação] [Supinador] [C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    supinador_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Supinação] [Supinador] [C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    supinador_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Supinação] [Supinador] [C6] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    pronador_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Pronação] [Pronador Redondo/Quadrado] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    pronador_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Pronação] [Pronador Redondo/Quadrado] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    pronador_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Pronação] [Pronador Redondo/Quadrado] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    pronador_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Pronação] [Pronador Redondo/Quadrado] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    pronador_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Pronação] [Pronador Redondo/Quadrado] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    pronador_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Pronação] [Pronador Redondo/Quadrado] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_radial_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Flexor Radial/Ulnar do Carpo] [C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_radial_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Flexor Radial/Ulnar do Carpo] [C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_radial_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Flexor Radial/Ulnar do Carpo] [C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_radial_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão] [Flexor Radial/Ulnar do Carpo] [C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_radial_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão] [Flexor Radial/Ulnar do Carpo] [C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_radial_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão] [Flexor Radial/Ulnar do Carpo] [C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    radial_carpo_ulnar_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Ext. Radial Longo e Curo Carpo Ext. Ulnar do Carpo] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    radial_carpo_ulnar_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Ext. Radial Longo e Curo Carpo Ext. Ulnar do Carpo] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    radial_carpo_ulnar_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Ext. Radial Longo e Curo Carpo Ext. Ulnar do Carpo] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    radial_carpo_ulnar_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão] [Ext. Radial Longo e Curo Carpo Ext. Ulnar do Carpo] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    radial_carpo_ulnar_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão] [Ext. Radial Longo e Curo Carpo Ext. Ulnar do Carpo] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    radial_carpo_ulnar_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão] [Ext. Radial Longo e Curo Carpo Ext. Ulnar do Carpo] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_superficial_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AIFP] [Flexor Superficial Dedos] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_superficial_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AIFP] [Flexor Superficial Dedos] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_superficial_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AIFP] [Flexor Superficial Dedos] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_superficial_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AIFP] [Flexor Superficial Dedos] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_superficial_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AIFP] [Flexor Superficial Dedos] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_superficial_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AIFP] [Flexor Superficial Dedos] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_profundo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AIFD] [Flexor Profundo Dedos] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_profundo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AIFD] [Flexor Profundo Dedos] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_profundo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AIFD] [Flexor Profundo Dedos] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_profundo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AIFD] [Flexor Profundo Dedos] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_profundo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AIFD] [Flexor Profundo Dedos] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_profundo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AIFD] [Flexor Profundo Dedos] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    extensao_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão AMCF] [Ext. Comum Dedos/Próprio Ind./ Próprio Mínimo] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensao_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão AMCF] [Ext. Comum Dedos/Próprio Ind./ Próprio Mínimo] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensao_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão AMCF] [Ext. Comum Dedos/Próprio Ind./ Próprio Mínimo] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensao_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão AMCF] [Ext. Comum Dedos/Próprio Ind./ Próprio Mínimo] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    extensao_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão AMCF] [Ext. Comum Dedos/Próprio Ind./ Próprio Mínimo] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    extensao_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão AMCF] [Ext. Comum Dedos/Próprio Ind./ Próprio Mínimo] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    palmares_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução Dedos] [Interosseos Palmares] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    palmares_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução Dedos] [Interosseos Palmares] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    palmares_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução Dedos] [Interosseos Palmares] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    palmares_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução Dedos] [Interosseos Palmares] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    palmares_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução Dedos] [Interosseos Palmares] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    palmares_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução Dedos] [Interosseos Palmares] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    dorsais_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Dedos] [Interosseos Dorsais] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    dorsais_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Dedos] [Interosseos Dorsais] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    dorsais_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Dedos] [Interosseos Dorsais] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    dorsais_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Dedos] [Interosseos Dorsais] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    dorsais_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Dedos] [Interosseos Dorsais] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    dorsais_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Dedos] [Interosseos Dorsais] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    lumbricais_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AMCF] [Lumbricais + Interosseos] [C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    lumbricais_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AMCF] [Lumbricais + Interosseos] [C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    lumbricais_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AMCF] [Lumbricais + Interosseos] [C6, C7, C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    lumbricais_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AMCF] [Lumbricais + Interosseos] [C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    lumbricais_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AMCF] [Lumbricais + Interosseos] [C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    lumbricais_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AMCF] [Lumbricais + Interosseos] [C6, C7, C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    abdutor_minimo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Mínimo] [Abdutor Mínimo] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_minimo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Mínimo] [Abdutor Mínimo] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_minimo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Mínimo] [Abdutor Mínimo] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_minimo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Mínimo] [Abdutor Mínimo] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_minimo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Mínimo] [Abdutor Mínimo] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_minimo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Mínimo] [Abdutor Mínimo] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    oponente_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Oponência do 5º Dedo] [Oponente] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Oponência do 5º Dedo] [Oponente] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Oponência do 5º Dedo] [Oponente] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Oponência do 5º Dedo] [Oponente] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Oponência do 5º Dedo] [Oponente] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Oponência do 5º Dedo] [Oponente] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_curto_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AMCF Polegar] [Flexor Curto] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_curto_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AMCF Polegar] [Flexor Curto] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_curto_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AMCF Polegar] [Flexor Curto] [C6, C7, C8] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_curto_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AMCF Polegar] [Flexor Curto] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_curto_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AMCF Polegar] [Flexor Curto] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_curto_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AMCF Polegar] [Flexor Curto] [C6, C7, C8] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    flexor_longo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AIF Polegar] [Flexor Longo] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_longo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AIF Polegar] [Flexor Longo] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_longo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AIF Polegar] [Flexor Longo] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_longo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Flexão AIF Polegar] [Flexor Longo] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_longo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Flexão AIF Polegar] [Flexor Longo] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    flexor_longo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Flexão AIF Polegar] [Flexor Longo] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    extensor_curto_longo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão Polegar] [Extensor Curto/Longo] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_curto_longo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão Polegar] [Extensor Curto/Longo] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_curto_longo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão Polegar] [Extensor Curto/Longo] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_curto_longo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Extensão Polegar] [Extensor Curto/Longo] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_curto_longo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Extensão Polegar] [Extensor Curto/Longo] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    extensor_curto_longo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Extensão Polegar] [Extensor Curto/Longo] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    abdutor_curto_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Polegar] [Abdutor Curto] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_curto_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Polegar] [Abdutor Curto] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_curto_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Polegar] [Abdutor Curto] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_curto_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Polegar] [Abdutor Curto] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_curto_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Polegar] [Abdutor Curto] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_curto_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Polegar] [Abdutor Curto] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    abdutor_longo_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Polegar] [Abdutor Longo] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_longo_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Polegar] [Abdutor Longo] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_longo_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Polegar] [Abdutor Longo] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_longo_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Abdução Polegar] [Abdutor Longo] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_longo_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Abdução Polegar] [Abdutor Longo] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    abdutor_longo_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Abdução Polegar] [Abdutor Longo] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    adutor_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução Polegar] [Adutor] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    adutor_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução Polegar] [Adutor] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    adutor_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução Polegar] [Adutor] [C8, T1] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    adutor_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Adução Polegar] [Adutor] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    adutor_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Adução Polegar] [Adutor] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    adutor_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Adução Polegar] [Adutor] [C8, T1] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)

    oponente_polegar_esq_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Oponência Polegar] [Oponente] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_polegar_esq_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Oponência Polegar] [Oponente] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_polegar_esq_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Oponência Polegar] [Oponente] [C6, C7] [Esq.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_polegar_dir_1 = models.CharField(max_length=100, verbose_name=_('[1º] [Oponência Polegar] [Oponente] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_polegar_dir_2 = models.CharField(max_length=100, verbose_name=_('[2º] [Oponência Polegar] [Oponente] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
    oponente_polegar_dir_3 = models.CharField(max_length=100, verbose_name=_('[3º] [Oponência Polegar] [Oponente] [C6, C7] [Dir.]'), blank=True, choices=MAPA_MUSCULAR)
